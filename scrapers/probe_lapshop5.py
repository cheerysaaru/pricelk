"""Lapshop: dump card HTML around product links."""
import re
import requests
...
a = soup.select_one('a[href*="product/asus-vivobook"]')
if a:
    ...
    for depth in range(1, 6):
        ...
        if parent is not None and parent.name in ("div", "li", "article"):
            ...
            if cls and any("product" in c or "item" in c or "card" in c for c in cls):
